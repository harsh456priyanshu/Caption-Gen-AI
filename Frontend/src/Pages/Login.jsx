...
const Login = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col items-center mt-10 p-10 '>
      <div className=' w-80 flex flex-col bg-green-400 p-10  '>
        <header>
          <h3 className='text-xl mb-5  flex items-center pl-15 font-serif'>SignIn Here !</h3>
          <p className='text-sm flex justify-center font-serif mb-4'>Welcome back. We've missed you.</p>
        </header>
        ...
        <Link to="/signup" className="text-white font-medium text-md text-center font-serif">New User !</Link>
      </div>
    </div>
  )
}
